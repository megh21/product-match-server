...
from calibrate_text import get_calibrator  # Import calibrator factory
...
MIN_SHAPE = (1, 32)  # e.g., min batch 1, min seq len 32
OPT_SHAPE = (8, 128)  # e.g., optimal batch 8, optimal seq len 128
MAX_SHAPE = (
    16,
    128,
)  # e.g., max batch 16, max seq len 128 (must match MAX_SEQ_LENGTH from export/calib)
...
def build_engine(precision="fp16"):
    ...
    # Set shapes for both inputs assuming they share the same shape dynamics
    profile.set_shape(
